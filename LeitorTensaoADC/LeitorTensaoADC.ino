const int pinoSensor = A7; //PINO ANALÓGICO EM QUE O SENSOR ESTÁ CONECTADO
...
float valorR1 = 1000000; //VALOR DO RESISTOR 1 DO DIVISOR DE TENSÃO
float valorR2 = 100000; // VALOR DO RESISTOR 2 DO DIVISOR DE TENSÃO
...
void loop(){
   ...
   Serial.print(" MEDIA: ");
   Serial.println(amostras/1000, 2);
